...
export function exportSourceMappingCSV() {
  ...
  csvRows.push('');
  csvRows.push('"Generated by PBIP Lineage Explorer — free & open source | https://github.com/JihwanKimIKEA/pbi_Lineage"');
...
export function copySourceMappingText() {
  ...
  lines.push('https://github.com/JihwanKimIKEA/pbi_Lineage');
  return lines.join('\n');
}
